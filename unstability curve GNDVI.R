...
setwd("/Users/rt485/Downloads/Helfer/NMSU/10_4/Normal_irrigation/new_GDD_2_28_2023/GNDVI/new_control_6_7/single_control_11_30_2023/11_16/GV-stability_GNDVI")

third_nor <- read.table("gv_GNDVI_third_nor", header = T)
third_nor$Harvest <- "NIcut3"
third_nor$ndvi <- third_nor$ndvi*10

fourth_nor <- read.table("gv_GNDVI_fourth_nor", header = T)
fourth_nor$Harvest <- "NIcut4"
fourth_nor$ndvi <- fourth_nor$ndvi*10

fifth_nor <- read.table("gv_GNDVI_fifth_nor", header = T)
fifth_nor$Harvest <- "NIcut5"
fifth_nor$ndvi <- fifth_nor$ndvi*10

sixth_nor <- read.table("gv_GNDVI_sixth_nor", header = T)
sixth_nor$Harvest <- "NIcut6"
sixth_nor$ndvi <- sixth_nor$ndvi*10

seventh_nor <- read.table("gv_GNDVI_seventh_nor", header = T)
...
third_ET <- read.table("gv_GNDVI_thirdET", header = T)
third_ET$Harvest <- "SITcut3"
third_ET$ndvi <- third_ET$ndvi*10

fourth_ET <- read.table("gv_GNDVI_fourthET", header = T)
fourth_ET$Harvest <- "SITcut4"
fourth_ET$ndvi <- fourth_ET$ndvi*10

fifth_ET <- read.table("gv_GNDVI_fifthET", header = T)
fifth_ET$Harvest <- "SITcut5"
fifth_ET$ndvi <- fifth_ET$ndvi*10

seventh_ET <- read.table("gv_GNDVI_seventhET", header = T)
...
p2 <- p2  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
p2 <- p2 +  ggtitle("Unstable line (G11)")  +
  scale_colour_manual(values=c( "red","black", "aquamarine3", "deeppink", "mediumslateblue", "olivedrab1")) 
...
p3 <- p3  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
...
p4 <- p4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
...
p5 <- p5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
...
up2 <- up2 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
...
up3 <- up3 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
...
up4 <- up4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
...
up5 <- up5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")
