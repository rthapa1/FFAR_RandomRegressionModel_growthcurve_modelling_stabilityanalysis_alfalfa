...
setwd("/Users/rt485/Downloads/Helfer/NMSU/10_4/Normal_irrigation/new_GDD_2_28_2023/NDRE/single_control_11_30_2023/11_16/growthcurve_all")
third_ET <- read.table("gv_NDRE_third_new_ET", header = T)
#third_ET <- third_ET[,-4]
third_ET$Harvest <- "SITcut3"

fourth_ET <- read.table("gv_NDRE_fourth_new_ET", header = T)
#fourth_ET <- fourth_ET[,-4]
fourth_ET$Harvest <- "SITcut4"

fifth_ET <- read.table("gv_NDRE_fifth_new_ET", header = T)
#fifth_ET <- fifth_ET[,-4]
fifth_ET$Harvest <- "SITcut5"

seventh_ET <- read.table("gv_NDRE_seventh_new_ET", header = T)
#seventh_ET <- seventh_ET[,-4]
seventh_ET$Harvest <- "SITcut7"

third_nor <- read.table("gv_NDRE_third_new", header = T)
#third_nor <- third_nor[,-4]
third_nor$Harvest <- "NIcut3"

fourth_nor <- read.table("gv_NDRE_fourth_new", header = T)
#fourth_nor <- fourth_nor[,-4]
fourth_nor$Harvest <- "NIcut4"

fifth_nor <- read.table("gv_NDRE_fifth_new", header = T)
#fifth_nor <- fifth_nor[,-4]
fifth_nor$Harvest <- "NIcut5"

sixth_nor <- read.table("gv_NDRE_sixth_new", header = T)
#sixth_nor <- sixth_nor[,-4]
sixth_nor$Harvest <- "NIcut6"

seventh_nor <- read.table("gv_NDRE_seventh_new", header = T)
