...
p1 <- p1  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.005, -0.35)
...
p2 <- p2  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.017, -0.001)
...
p3 <- p3  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.225, 0.020)
...
p4 <- p4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.015, -0.32)
...
p5 <- p5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.05, -0.05)
...
up1 <- up1  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.005, -0.4)
...
up2 <- up2 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.017, -0.001)
...
up3 <- up3 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.225, 0.020)
...
up4 <- up4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.015, -0.32)
...
up5 <- up5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(0.4, -0.05)
