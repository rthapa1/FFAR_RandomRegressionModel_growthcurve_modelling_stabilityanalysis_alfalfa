...
setwd("/Users/rt485/Downloads/Helfer/NMSU/10_4/Normal_irrigation/new_GDD_2_28_2023/NDVI/single_control_11_30_2023/11_16/third/auc")
...
write.table(dat_final, file = "gv_NDVI_third_auc", row.names = F)
