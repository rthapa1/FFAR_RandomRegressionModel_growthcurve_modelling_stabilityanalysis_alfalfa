setwd("/Users/rt485/Downloads/Helfer/NMSU/10_4/Normal_irrigation/new_GDD_2_28_2023/NIR/single_control_11_30_2023/11_16/GV-stability_NIR")

third_nor <- read.table("gv_NIR_third_nor", header = T)
third_nor$Harvest <- "NIcut3"
third_nor$ndvi <- third_nor$ndvi*10

fourth_nor <- read.table("gv_NIR_fourth_nor", header = T)
fourth_nor$Harvest <- "NIcut4"
fourth_nor$ndvi <- fourth_nor$ndvi*10

fifth_nor <- read.table("gv_NIR_fifth_nor", header = T)
fifth_nor$Harvest <- "NIcut5"
fifth_nor$ndvi <- fifth_nor$ndvi*10

sixth_nor <- read.table("gv_NIR_sixth_nor", header = T)
sixth_nor$Harvest <- "NIcut6"
sixth_nor$ndvi <- sixth_nor$ndvi*10

seventh_nor <- read.table("gv_NIR_seventh_nor", header = T)
...
third_ET <- read.table("gv_NIR_third_ET", header = T)
third_ET$Harvest <- "SITcut3"
third_ET$ndvi <- third_ET$ndvi*10

fourth_ET <- read.table("gv_NIR_fourth_ET", header = T)
fourth_ET$Harvest <- "SITcut4"
fourth_ET$ndvi <- fourth_ET$ndvi*10

fifth_ET <- read.table("gv_NIR_fifth_ET", header = T)
fifth_ET$Harvest <- "SITcut5"
fifth_ET$ndvi <- fifth_ET$ndvi*10

seventh_ET <- read.table("gv_NIR_seventh_ET", header = T)
