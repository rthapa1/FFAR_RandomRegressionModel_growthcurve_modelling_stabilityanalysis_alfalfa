...
p1 <- p1  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.4, 0.3)
...
p2 <- p2  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.03, 0.07)
...
p3 <- p3  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.03, 0.08)
...
p4 <- p4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.2, 0.02)
...
p5 <- p5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.01, 0.086)
...
up1 <- up1  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.4, 0.3)
...
up2 <- up2 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.03, 0.07)
...
up3 <- up3 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.03, 0.08)
...
up4 <- up4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.2, 0.02)
...
up5 <- up5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+   ylim(-0.01, 0.086)
