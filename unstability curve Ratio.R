setwd("/Users/rt485/Downloads/Helfer/NMSU/10_4/Normal_irrigation/new_GDD_2_28_2023/Ratio/single_control_11_30_2023/11_16/GV_stability_Ratio")

third_nor <- read.table("gv_Ratio_third_nor", header = T)
third_nor$Harvest <- "NIcut3"
third_nor$ndvi <- third_nor$ndvi*10

fourth_nor <- read.table("gv_Ratio_fourth_nor", header = T)
fourth_nor$Harvest <- "NIcut4"
fourth_nor$ndvi <- fourth_nor$ndvi*10

fifth_nor <- read.table("gv_Ratio_fifth_nor", header = T)
fifth_nor$Harvest <- "NIcut5"
fifth_nor$ndvi <- fifth_nor$ndvi*10

sixth_nor <- read.table("gv_Ratio_sixth_nor", header = T)
sixth_nor$Harvest <- "NIcut6"
sixth_nor$ndvi <- sixth_nor$ndvi*10

seventh_nor <- read.table("gv_Ratio_seventh_nor", header = T)
...
third_ET <- read.table("gv_Ratio_third_ET", header = T)
third_ET$Harvest <- "SITcut3"
third_ET$ndvi <- third_ET$ndvi*10

fourth_ET <- read.table("gv_Ratio_fourth_ET", header = T)
fourth_ET$Harvest <- "SITcut4"
fourth_ET$ndvi <- fourth_ET$ndvi*10

fifth_ET <- read.table("gv_Ratio_fifth_ET", header = T)
fifth_ET$Harvest <- "SITcut5"
fifth_ET$ndvi <- fifth_ET$ndvi*10

seventh_ET <- read.table("gv_Ratio_seventh_ET", header = T)
...
p1 <- p1  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit") +  ylim(-0.01, 0.17)
p1 <- p1 +  ggtitle("Unstable line (G1)")  +
...
p2 <- p2  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(0, 0.15)
p2 <- p2 +  ggtitle("Unstable line (G12)")  +
  scale_colour_manual(values=c( "red","black", "aquamarine3", "deeppink", "mediumslateblue", "olivedrab1")) 
...
p3 <- p3  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.15, 0.01)
p3 <- p3 +  ggtitle("Unstable line (G17)")  +
  scale_colour_manual(values=c( "red","black", "aquamarine3", "deeppink", "mediumslateblue", "olivedrab1")) 
...
p4 <- p4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.06, 0.1)
p4 <- p4 +  ggtitle("Unstable line (G21)")  +
  scale_colour_manual(values=c( "red","black", "aquamarine3", "deeppink", "mediumslateblue", "olivedrab1")) 
...
p5 <- p5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.02, 0.128)
p5 <- p5 +  ggtitle("Unstable line (G23)")  +
  scale_colour_manual(values=c( "red","black", "aquamarine3", "deeppink", "mediumslateblue", "olivedrab1")) 
...
up1 <- up1  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.01, 0.17)
...
up2 <- up2 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(0, 0.15)
up2 <- up2 +  ggtitle("Unstable line (G12)")  +
  scale_colour_manual(values=c( "red","black", "aquamarine3",  "mediumslateblue", "olivedrab1")) 
...
up3 <- up3 + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.15, 0.01)
...
up4 <- up4  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.06, 0.1)
...
up5 <- up5  + geom_line()+ xlab("Growing degree days (GDD)") + ylab("Genetic Merit")+  ylim(-0.02, 0.128)
